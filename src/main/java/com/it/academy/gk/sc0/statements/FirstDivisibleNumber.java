...
public class FirstDivisibleNumber {
     ...
     * <p/>
     * This method finds the first number divisible
     * by the given divisor on the interval [lowerBound; upperBound] using the Stream API.
     * It generates a stream of integers from lowerBound to upperBound, inclusive,
     * and filters the stream to include only numbers that are divisible by divisor.
     * It then returns the first number in the filtered stream, or -1 if no such number is found.
     *

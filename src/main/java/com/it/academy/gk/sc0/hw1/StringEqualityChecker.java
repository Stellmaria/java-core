...
public class StringEqualityChecker {
     ...
     * Use the equals method of the String class to compare the two strings.
     * If they are equal, return the EQUAL_STRINGS_MESSAGE constant.
     * Otherwise, return the UNEQUAL_STRINGS_MESSAGE constant
     *
     ...
     */
    public String areStringsEqual(@NotNull final String string1, final String string2) {

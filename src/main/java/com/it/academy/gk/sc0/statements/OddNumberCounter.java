...
public class OddNumberCounter {
    ...
    /**
     * Counts the number of odd numbers from zero to a given integer n.
     * <p/>
     * This method counts the number of odd numbers from zero to a given integer n using the Stream API.
     * If it is less than the lower bound, it returns zero.

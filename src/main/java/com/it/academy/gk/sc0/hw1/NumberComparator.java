...
public class NumberComparator {
     ...
     * <p/>
     * This method compares two numbers entered by the user
     * and returns a string that describes the result of the comparison.
     * If the first number is greater than the second number,
     * it returns "The first number is greater than the second number."
     * If the first number is less than the second number, it returns "The first number is less than the second number."
     ...
     */
    public String compareNumbers(final double firstNumber, final double secondNumber) {

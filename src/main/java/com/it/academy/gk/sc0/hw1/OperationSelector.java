...
/**
 * Write a console program that displays to the user
 * message. "Enter operation number: 1. Addition 2. Subtraction
 * 3. Multiplication." Next to the name of each operation is indicated its
 * number — for example, the subtraction operation has number 2.
 * Let the user enter the operation number in the program,
 * and depending on this number, the program displays the name
 * operations. To determine the operation by the entered number,
 * use the switch...case construct. If the entered
 * user number does not match any operation
 * (for example, the number 120), then display a message to the user
...
public class OperationSelector {
     ...
     */
    private static final String PROMPT_MESSAGE = "Enter the number of the operation: 1. Addition 2. Subtraction 3. Multiplication";
    /**
     ...
     * It then reads the number entered by the user and uses an if statement to determine the name
     * of the corresponding operation. If the entered number corresponds to a valid operation,
     * it returns the name of that operation. Otherwise, it returns a message indicating
     * that the operation is not defined.
     *
     ...
     */
    public String selectOperation(int operationNumber) {
        var result = new StringBuilder();
        result.append(PROMPT_MESSAGE).append(SEPARATOR);

...
public class PrintNumbers {
     ...
     * it concatenates it with the SEPARATOR and collects all strings into a single string using Collectors.joining().
     *
     ...
     * <p/>
     * This method generates a string of numbers from first to last, incremented by increment, separated by a space.
     * It uses an IntStream to generate a stream of integers from first to last, inclusive, incremented by increment.
     * For each integer in the stream,
     * it concatenates it with the SEPARATOR and collects all strings into a single string using Collectors.joining().
     *
     ...
     * It uses an IntStream to generate a stream of integers from upperBound to lowerBound, inclusive, decremented by 1.
     * For each integer in the stream, it concatenates it with the SEPARATOR

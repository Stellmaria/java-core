...
/**
 * The user enters two numbers. One is assigned
 * one variable and the other. Necessary
 * change the values of the variables so that the value
 * the first turned out to be in the second, and the second - in the first.
 */
public class VariableSwapper {
     ...
     */
    public String swapVariables(int firstVariable, int secondVariable) {
        var result = new StringBuilder();
        var temp = firstVariable;
        firstVariable = secondVariable;
        secondVariable = temp;

        result.append(String.format(RESULT_MESSAGE, firstVariable, secondVariable));

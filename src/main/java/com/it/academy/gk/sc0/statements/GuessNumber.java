...
public class GuessNumber {
     ...
     * This method uses the `logger` field to display messages to the player,
     * and the `scanner` field to read the player's guesses.
     * It enters a loop that continues until the player correctly guesses the number stored in the `number` field.
     * During each iteration of the loop, it prompts the player to enter their guess,
     * reads an integer from `scanner`, and compares it to `number`.

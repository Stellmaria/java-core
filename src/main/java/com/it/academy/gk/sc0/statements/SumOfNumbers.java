 ...
 * the sum of all numbers from one to the entered number.
 * <p/>
 * Task 9.
...
public class SumOfNumbers {
     ...
     * @return the sum of numbers from one to n.
     */
    ...
    /**
     * Calculates the sum of numbers from one to n
     * and prints the intermediate sums until the sum exceeds the given limit.
     * <p/>
     * This method calculates the sum of numbers from one to n
     * and prints the intermediate sums until the sum exceeds the given limit using the Stream API.
     * It generates a stream of integers from one to n, inclusive,
     ...
     * <p/>
     * This method prompts the user to enter non-zero numbers until the user enters zero.
     * It then calculates the sum of all entered numbers and returns it as a string.
     *
